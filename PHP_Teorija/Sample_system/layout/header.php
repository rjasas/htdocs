        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarItems">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="http://localhost/practice/jan27/sample_system/" class="nav-link">File
                            Upload Form</a>
                    </li>
                    <li class="nav-item">
                        <a href="http://localhost/practice/jan27/sample_system/"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="http://localhost/practice/jan27/sample_system/">KMI</a>
